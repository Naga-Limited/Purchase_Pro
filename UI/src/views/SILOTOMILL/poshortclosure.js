...
const MyCanteenForm = () => {
  ...
  useEffect(() => {
    showLoader();
    apiPostMethod(apiBaseUrl + "GatePro/Report/getpolistforclosure")
      .then((response) => {
        const { data } = response;
  ...
  const handleFilter = () => {
    try {
      ...
      showLoader();
      apiPostMethod(apiBaseUrl + "GatePro/Report/getpolistforrevert", postdata)
        .then((response) => {
          const { data } = response;
          if (data && data.success) {
            setData(data.results || []);
  ...
  const handleShortClose = (row) => {
    ...
    confirmDialog({
      ...
      .then((confirmed) => {
        ...
        showLoader();
        apiPostMethod(apiBaseUrl + "GatePro/Report/shortclosepo", postdata)
          .then((response) => {
            const { data } = response;
  ...
  const handleRevert = (row) => {
    ...
    confirmDialog({
      ...
      .then((confirmed) => {
        ...
        showLoader();
        apiPostMethod(apiBaseUrl + "GatePro/Report/revertpo", postdata)
          .then((response) => {
            const { data } = response;
            if ( data.success == true ){
  ...
  return (
    <div>
      ...
      <Card>
        <CardHeader>
          <CardTitle>PO Short Closure</CardTitle>
        </CardHeader>
        <CardBody>
          <Fragment>
            <Row>
