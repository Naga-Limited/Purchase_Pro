...
function CreditMemoReceiptRejectedlist() {
    ...
    const handleEdit = (row) => {
        history.push(`/CREDITMEMOEDIT:${row.credit_memo_id}`);
    };
    ...
    return (
        <CardComponent header="Rejected Credit Memo List">
            <TableComponent columns={columns} data={memoList} />
        </CardComponent>
    );
}

export default CreditMemoReceiptRejectedlist;
