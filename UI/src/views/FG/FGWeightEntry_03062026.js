    ...
    apiPostMethod(apiBaseUrl + `GatePro/Weighment/getWeighmentInfo/${truckValue||truck_no}/0/${UserDetails.USERID}/${documentNo}`)
      .then((response) => {
        ...
        if (data.success == true) {
          ...
          let moduleType = data.data[0].moduleTypeId == 12 || data.data[0].moduleTypeId == 15 || (data.data[0].moduleTypeId == 33 && data.data[0].userGateId	!= 19) || data.data[0].moduleTypeId == 34 || data.data[0].moduleTypeId == 21 || data.data[0].moduleTypeId == 25 || data.data[0].moduleTypeId == 2 || data.data[0].moduleTypeId == 29 || data.data[0].moduleTypeId == 1

          if (((moduleType && showDocument == false) && data.data[0].firstWeight != null && ((data.data[0].isRedirect == 0 || data.data[0].isRedirect == null && data.data[0].waitingAt != 9) || ((data.data[0].moduleTypeId == 1 || data.data[0].moduleTypeId == 2) && data.data[0].waitingAt != 9))) || (showDocument == false && (data.data[0].moduleTypeId == 12 || data.data[0].moduleTypeId == 15 || (data.data[0].moduleTypeId == 33 && data.data[0].userGateId	!= 19) || data.data[0].moduleTypeId == 34 || data.data[0].moduleTypeId == 21) && (data.data[0].isRedirect == 0 || data.data[0].isRedirect == null))) {
            setShowDocument(true)
            getDocumentDetails(data.data[0].gateInOutInfoId)
            setIsDisabled(true)
          }
          else if ((data.data[0].moduleStatusId == 2 || data.data[0].moduleStatusId == 9) || (moduleType) || data.data[0].moduleStatusId == 4 || data.data[0].moduleTypeId == 19 || data.data[0].moduleTypeId == 8 || data.data[0].moduleTypeId == 43) {
            if (moduleType || data.data[0].moduleTypeId == 19 || data.data[0].moduleTypeId == 8 || data.data[0].moduleTypeId == 43) { 
              if (data.data[0].secondWeight == null || data.data[0].isGateInOutInfo == 1 || data.data[0].isRedirect == 0 ||  data.data[0].moduleTypeId == 19 || data.data[0].moduleTypeId == 8 || data.data[0].moduleTypeId == 43) { 
                setData(data.data[0])
                setIsDisabled(true)
