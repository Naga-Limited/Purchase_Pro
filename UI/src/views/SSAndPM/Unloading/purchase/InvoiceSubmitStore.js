...
const InvoiceSubmitStore = ({ }) => {
    ...
    const update = (shipmentCopys,ExtraAttachments) => {
        ...
        let postData = {
            ...
            bargainNote: ExtraAttachments.bargainNote || filteredPoData[0]?.bargainNotes || filteredPoData[0]?.bargainNote,
            deliveryChallanCopy: ExtraAttachments.deliveryChallanCopy || filteredPoData[0]?.deliveryChallanCopys || filteredPoData[0]?.deliveryChallanCopy,
            ewayBillCopy: ExtraAttachments.ewayBillCopy || filteredPoData[0]?.ewayBillCopys || filteredPoData[0]?.ewayBillCopy,
            eInvoiceCopy: ExtraAttachments.eInvoiceCopy || filteredPoData[0]?.eInvoiceCopys || filteredPoData[0]?.eInvoiceCopy,
            qcCertificateInternalCopy: ExtraAttachments.qcCertificateInternalCopy || filteredPoData[0]?.qcCertificateInternalCopys || filteredPoData[0]?.qcCertificateInternalCopy,
            qcCertificateExternalCopy: ExtraAttachments.qcCertificateExternalCopy || filteredPoData[0]?.qcCertificateExternalCopys || filteredPoData[0]?.qcCertificateExternalCopy,
            externalWbCopy: ExtraAttachments.externalWbCopy || filteredPoData[0]?.externalWbCopys || filteredPoData[0]?.externalWbCopy,
            vendorEmailCopy: ExtraAttachments.vendorEmailCopy || filteredPoData[0]?.vendorEmailCopys || filteredPoData[0]?.vendorEmailCopy,
            projectTeamAcknowledgement: ExtraAttachments.projectTeamAcknowledgement || filteredPoData[0]?.projectTeamAcknowledgements || filteredPoData[0]?.projectTeamAcknowledgement,
            creditNoteCopy: ExtraAttachments.creditNoteCopy || filteredPoData[0]?.creditNoteCopys || filteredPoData[0]?.creditNoteCopy,
        };
