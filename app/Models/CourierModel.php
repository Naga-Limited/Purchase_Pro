...
class CourierModel extends Model
{
  ...
  {
    $builder = $this->db->query("SELECT  `emp_designation`, `emp_department`,`emp_division`,  `emp_mobile_number`,  `emp_mail_id`, `emp_code`,`emp_id` ,`plant_code`,`emp_costcentre`  FROM `employee_master` WHERE emp_id ='$employeename'");
