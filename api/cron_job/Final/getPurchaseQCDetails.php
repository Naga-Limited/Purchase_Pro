...
if ($handle = opendir($URL)) {
          ...
          foreach ($importData_arr as $data) {
            if ($skip != 0) {
              ...
              $Ash = mysqli_real_escape_string($connect, trim($data[10]));
	            $TW = mysqli_real_escape_string($connect, trim($data[20]));
             ...
             $PD_Duram = mysqli_real_escape_string($connect, trim($data[35] ?? 0));
 ...
 $insert_query = "INSERT INTO `stm_silotomillqcdet`( `AnalysisTime`,
               ...
               `ShriveledWheat`, `ImmatureWheat`, `InsectDamageWheat`, `KernalBunt`, `RainGrain`, `OFG`, `PD_DuramWheat`
                 ...
                 '$SoftWheat','$ShriveledWheat','$ImmatureWheat','$InsectDamageWheat','$KernelBunt','$RedGrain','$OFG','$PD_Duram')";
